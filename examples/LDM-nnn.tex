...
\setDocUpstreamLocation{GitHub or MagicDraw}
\setDocUpstreamVersion{SHA1 or model version}
...
\setDocChangeRecord{%
\addtohist{1}{2017-03-10}{Initial release. Based on Gaia examples.}{Tim Jenness}
