...
- `latex_lsstdoc <https://github.com/lsst/templates/tree/master/project_templates/latex_lsstdoc>`__ for general-purpose lsstdoc-class documents
- `technote_latex <https://github.com/lsst/templates/tree/master/project_templates/technote_latex>`__ for technical notes
- `test_report <https://github.com/lsst/templates/tree/master/project_templates/test_report>`__ for test reports that integrate with docsteady.
