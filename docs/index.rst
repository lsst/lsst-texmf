...
To get started, :ref:`install <install>` lsst-texmf on your computer and check out the :ref:`example projects <examples>`.
Next, learn more about :ref:`writing documents <lsstdoc>` with the ``lsstdoc`` class and :ref:`making Beamer presentations <lsst-texmf-beamer>` with the ``LSST-beamer`` style file.
