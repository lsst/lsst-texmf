...
def generate_bibfile(outfile, query: str = "", reference: str | None = None) -> None:
    """
    ...
    print(bibdata.to_string("bibtex"), file=outfile)
...
if __name__ == "__main__":
    ...
    generate_bibfile(outfile, args.query, args.reference)
    outfile.close()
